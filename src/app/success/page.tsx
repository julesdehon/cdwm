  ...
  return (
    <div className={[styles.page, styles.centered].join(" ")}>
      <main className={styles.main}>
        ...
        <img src={"https://i.giphy.com/media/v1.Y2lkPTc5MGI3NjExY3Y3ZmZ2M3RndTNwaHdocTAxcTdhODk0ZWFvcnlvY2ZtNWF4NXF1biZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/13LlAxmDwAkopO/giphy.gif"}  alt={"A GIF showing a happy chef"}/>
